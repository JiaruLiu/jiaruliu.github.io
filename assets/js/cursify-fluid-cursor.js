(function () {
  ...
  window.addEventListener('load', function () {
    var shouldRun = document.getElementById('fluid') && matchMedia('(pointer:fine)').matches && !matchMedia('(prefers-reduced-motion: reduce)').matches;
    if (shouldRun) useFluidCursor();
  });
})();
